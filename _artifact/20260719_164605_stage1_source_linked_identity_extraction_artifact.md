...
- **runID**: `20260719_164605`  (minted INTERNALLY by stable_key_construction (E2); NOT an input)
...
| 9 | runID minted internally, not accepted as an input | PASS (`20260719_164605`) |
...
- **sealed artifact**: `_artifact/20260719_164605_stage1_source_linked_identity_extraction_artifact.md`
